...
class Ui_dashboard(object):
    def setupUi(self, dashboard):
        ...
        self.analyse.setPixmap(QPixmap(u"../../Downloads/magnifying-glass (1).png"))
        ...
        self.traffic.setGeometry(QRect(620, 190, 131, 81))
        self.traffic.setPixmap(QPixmap(u"../../Downloads/computer (1).png"))
        self.Scan = QLabel(dashboard)
        self.Scan.setObjectName(u"Scan")
        self.Scan.setGeometry(QRect(110, 200, 71, 91))
        self.Scan.setPixmap(QPixmap(u"../../Downloads/responsive (1).png"))
